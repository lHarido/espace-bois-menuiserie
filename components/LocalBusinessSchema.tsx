...
export function LocalBusinessSchema() {
  ...
  const areaServed = [
    ...
    { "@type": "City", name: "Confort" },
    { "@type": "City", name: "Valserhône" },
    { "@type": "City", name: "Bellegarde-sur-Valserine" },
    { "@type": "City", name: "Lancrans" },
    { "@type": "City", name: "Châtillon-en-Michaille" },
    { "@type": "City", name: "Collonges" },
    { "@type": "City", name: "Léaz" },
    { "@type": "City", name: "Gex" },
    ...
    { "@type": "City", name: "Archamps" },
    { "@type": "City", name: "Neydens" },
    { "@type": "City", name: "Viry" },
    { "@type": "City", name: "Valleiry" },
    { "@type": "City", name: "Frangy" },
    { "@type": "City", name: "Seyssel" },

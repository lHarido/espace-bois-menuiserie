...
export const company = {
  ...
  tagline: "Menuiserie bois, PVC & aluminium dans l'Ain, le Pays de Gex et la Haute-Savoie proche",
  description:
    "Fenêtres, portes, volets, escaliers, parquets et agencements sur mesure depuis Confort près de Valserhône, dans l'Ain (01), le Pays de Gex et la Haute-Savoie (74) proche.",
  ...
  areas: [
    ...
    "Ain (01)",
    "Pays de Gex",
    "Gex, Divonne-les-Bains, Ferney-Voltaire, Saint-Genis-Pouilly, Thoiry, Cessy, Prévessin-Moëns",
    "Nantua / Oyonnax, selon chantier",
    "Haute-Savoie (74) proche",
    "Saint-Julien-en-Genevois, Archamps, Neydens, Viry, Valleiry, Frangy, Seyssel, Cruseilles, selon chantier",
  ...
  seoTerms: [
    ...
    "menuiserie Ain",
    "pose fenêtres Ain",
    "fenêtres aluminium RAL 7016 Ain",
    "fenêtres PVC blanc Ain",
    "volets roulants Ain",
    "menuisier Haute-Savoie 74",
    "menuisier Haute-Savoie",
    "menuiserie Haute-Savoie proche",
    "pose fenêtres Haute-Savoie",
    "fenêtres aluminium RAL 7016 Haute-Savoie",
    "fenêtres PVC blanc Haute-Savoie",
    "volets roulants Haute-Savoie",
    "menuisier Pays de Gex",
    "menuiserie Pays de Gex",
    "pose fenêtres Pays de Gex",
    "fenêtres aluminium RAL 7016 Pays de Gex",
    "fenêtres PVC blanc Pays de Gex",
    "volets roulants Pays de Gex",
    "menuisier Gex",
    "menuisier Divonne-les-Bains",
    "menuisier Ferney-Voltaire",
    "menuisier Saint-Genis-Pouilly",
    "menuisier Thoiry",
    "menuisier Cessy",
    "menuisier Prévessin-Moëns",

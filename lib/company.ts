...
export const company = {
  ...
  description:
    "Fenêtres, portes, volets, escaliers, parquets et agencements sur mesure autour de Valserhône, dans l'Ain, le Pays de Gex et la Haute-Savoie proche.",
  ...
  areas: [
    ...
    "Ain (01)",
    "Pays de Gex",
    "Gex, Divonne-les-Bains, Ferney-Voltaire, Saint-Genis-Pouilly",
    "Nantua / Oyonnax, selon chantier",
    "Haute-Savoie proche",
    "Annecy, Saint-Julien-en-Genevois, Frangy, Seyssel, selon chantier",
